"""
Django settings for quiet_thunder_40613 project.
...
ROOT_URLCONF = 'quiet_thunder_40613.urls'
...
WSGI_APPLICATION = 'quiet_thunder_40613.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_thunder_40613 API",
    "DESCRIPTION": "API documentation for quiet_thunder_40613 App",
    "VERSION": "v1",
}
